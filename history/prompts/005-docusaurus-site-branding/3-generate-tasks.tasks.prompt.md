...
user: Claude user
command: /sp.tasks
labels: ["docusaurus", "branding", "ui", "tasks"]
links:
...
- [ ] T001 Create static directory for assets in frontend-book/static/
- [ ] T002 Create pages directory for landing page in frontend-book/src/pages/
...
- [ ] T003 Create new logo asset in frontend-book/static/img/logo.svg
- [ ] T004 Update docusaurus.config.js to reference new site title and branding
...
- [ ] T005 [US1] Create landing page component in frontend-book/src/pages/index.js with heading "Physical AI & Humanoid Robotics"
- [ ] T006 [US1] Add introduction text to landing page in frontend-book/src/pages/index.js as specified in requirements
- [ ] T007 [US1] Add "Start Reading" button to landing page in frontend-book/src/pages/index.js that links to first module
- [ ] T008 [US1] Style landing page to match Docusaurus conventions in frontend-book/src/pages/index.js
...
- [ ] T009 [US2] Update navbar configuration in frontend-book/docusaurus.config.js to remove blog link
- [ ] T010 [US2] Update navbar configuration in frontend-book/docusaurus.config.js to remove GitHub link
- [ ] T011 [US2] Verify navbar only contains relevant items in frontend-book/docusaurus.config.js
...
- [ ] T012 [US3] Update site title in frontend-book/docusaurus.config.js to "Physical AI & Humanoid Robotics"
- [ ] T013 [US3] Update navbar title in frontend-book/docusaurus.config.js to "Physical AI & Humanoid Robotics"
- [ ] T014 [US3] Update site tagline in frontend-book/docusaurus.config.js to reflect Physical AI & Humanoid Robotics
- [ ] T015 [US3] Verify logo displays correctly in navbar in frontend-book/docusaurus.config.js
...
- [ ] T016 [US4] Update sidebar label from "Tutorial" to "Text Book" in frontend-book/docusaurus.config.js
- [ ] T017 [US4] Update sidebar configuration in frontend-book/sidebars.js to ensure proper "Text Book" labeling
- [ ] T018 [US4] Verify all modules appear under "Text Book" section in frontend-book/sidebars.js
- [ ] T019 [US4] Ensure "Start Reading" button from landing page navigates to Module 1 of Text Book
...
- [ ] T020 Update footer links to reflect new branding in frontend-book/docusaurus.config.js
- [ ] T021 Verify all existing documentation content remains accessible under new structure
- [ ] T022 Test site locally to ensure all changes work together properly
...
# Developer C: User Story 4 - Text Book content access
# Developer D: User Story 3 - Consistent branding
```
...
- ✅ Impact: Created comprehensive task list for Docusaurus site rebranding project
- 🧪 Tests: Validated all functional requirements are covered in tasks
- 📁 Files: Created tasks.md with 23 specific implementation tasks
...
- Next experiment (smallest change to try): Begin implementation of T001-T004 (setup and foundational)